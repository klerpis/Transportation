...
class LocationAdmin(ModelAdmin):
    list_display = ['state', 'local_government', 'bus_stop', 'street', 'lat', 'lng']
...
class TripAdmin(ModelAdmin):
    ...
    fieldsets = (
        ('Trip Data', {"fields":  ['trip_id', 'route', 'trip_departure_date', 
...
class FeedbackAdmin(ModelAdmin):
    list_display = ['user', 'rating', 'booking_id', 'trip_id']
    list_filter = ['rating']
    # list_editable = []
