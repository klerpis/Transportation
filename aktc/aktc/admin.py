...
class BookTicketAdmin(ModelAdmin):
    ...
    # def the_trip_id(self, obj):
    #     booking = models.Booking.objects.filter(id=obj.id).first()
    #     print("obj ofr the trip id", dir(obj))
    #     print()
    #     print()
    #     print('tester', obj.trip)
    #     print('tester', booking.trip)
    #     print()
    #     print("THE TYPE", type(obj))
    #     return obj.trip.seats_booked
...
class BusAdmin(ModelAdmin):
    list_display = ['registration_number',
                    'bus_name', 'bus_seat_num', 'bus_status']
...
class CustomerAdmin(ModelAdmin):
    ...
    fieldsets = (
        ('Credentials', {"fields": [
         'user', 'firstname', 'middlename', 'surname', 'email']}),
...
class LocationAdmin(ModelAdmin):
    list_display = ['state', 'local_government',
                    'bus_stop', 'street', 'lat', 'lng', 'featured']
    list_editable = ['lat', 'lng', 'featured',]
    search_fields = ['state', 'local_government',
                     'bus_stop', 'street', 'lat', 'lng']
    # readonly_fields = []

    fieldsets = (
        ('Address', {"fields":  [
         'state', 'local_government', 'bus_stop', 'street']}),
...
def update_status_to_published(modeladmin, request, queryset):
    ...
    modeladmin.message_user(
        request, f"{queryset.count()} items were successfully updated to 'completed'.")
...
class PaymentAdmin(ModelAdmin):
    ...
    search_fields = ['reference', 'booking_id',]
    # fieldsets = (
    #     ('Passenger Data', {"fields":  ['user', 'comment', 'rating',
    #     'submitted_at']}),
    #     ('Trip Data', {'fields': [ 'trip_books', 'submitted_at']}),
    ...
    # def trip_id(self, obj):
    #     return obj.booking.trip.trip_id
...
aktc_admin_site.register(
    setupsystemmodels.WeekDaysSchedule, WeekDaysScheduleAdmin)
