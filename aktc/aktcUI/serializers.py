...
from .models import (
    DepartureTime, Booking, Location,
    Feedback, BusDetail, Review, Trip, Payment
)
...
class PaymentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Payment
        fields = ['id', 'booking_id', 'amount', 'method', 'status', 'created']
